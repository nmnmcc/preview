...
The [examples](https://github.com/nmnmcc/preview/blob/main/examples/README.md)
directory has runnable projects for React, React Router, Vue, Svelte,
SvelteKit, and vinext. The main framework examples
...
See [the App Router example](https://github.com/nmnmcc/preview/tree/main/examples/vinext-app)
and [the Pages Router example](https://github.com/nmnmcc/preview/tree/main/examples/vinext-pages).
They test
